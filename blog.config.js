...
const BLOG = {
  // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/1867f65f641a432e8d1650d9c0774c87
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || '1867f65f641a432e8d1650d9c0774c87',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'yixiaoq', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://baidu.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'gege', // 网站关键词 英文逗号隔开
